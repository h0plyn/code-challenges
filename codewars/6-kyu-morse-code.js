...
// as ·−, letter Q is coded as −−·−, and digit 1 is coded as ·−−−−. The Morse code is case-insensitive, traditionally capital
    ...
    wordArr.forEach(word => {
        ...
        letterArr.forEach(letter => {
            for (let code in MORSE_CODE) {
                if (code === letter)  newWord += MORSE_CODE[code];
            }
        })
        decodedArr.push(newWord);
    })
