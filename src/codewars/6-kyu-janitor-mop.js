// Task
// In one city it is allowed to write words on the buildings walls. The local janitor, however, doesn't 
// approve of it at all. Every night he vandalizes the writings by erasing all occurrences of some letter. 
...
// An array of length 26. The first element is the minimum width of the mop to erase letter 'a', the second - 
// letter 'b' etc.
// Example
...
function theJanitor(word) {
    ...
    return alphabet.map(function(letter) {
        let a = word.indexOf(letter);
        let b = word.lastIndexOf(letter);
