...
const fruits_into_baskets = function (fruits) {
  ...
  for (let windowEnd = 0; windowEnd < fruits.length; windowEnd += 1) { // extend sliding window size
    ...
    while (Object.keys(fruitMap).length > 2) { // shirnk window until there are two fruits in the hashmap
